...
export class AccountManager {
    ...
    async initialize(strategyOverride = null) {
        ...
        const disableDbFallback = process.env.ANTIGRAVITY_DISABLE_DB_FALLBACK === 'true';
        ...
        if (this.#accounts.length === 0 && !disableDbFallback) {
        ...
        } else if (this.#accounts.length === 0 && disableDbFallback) {
            logger.info('[AccountManager] Database fallback disabled; waiting for OAuth accounts.');
        }
